...
public final class ServiceBoundaryConstants {
    ...
    public static final class Aigc {
        ...
        public static final String[] ROUTES = { "generate", "taskStatus", "models", "materials", "materialDetail", "materialTasks", "materialUpload", "gallery", "gallerySave", "assets", "assetDetail" };
