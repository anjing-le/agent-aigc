...
public final class ServiceBoundaryConstants {
    ...
    public static final class Aigc {
        ...
        public static final String[] ROUTES = { "generate", "taskStatus", "taskRetry", "models", "modelProbe", "modelActiveProvider", "modelProviderCredential", "modelProviderParams", "modelProviderSmokeTest", "modelProviderAudits", "modelProviderExecutionReport", "materials", "materialDetail", "materialTasks", "materialPreview", "materialDownload", "materialUpload", "storageStatus", "storageAudits", "ownershipBackfill", "gallery", "galleryRanking", "galleryCollections", "galleryTopics", "galleryCreatorRanking", "galleryAudits", "galleryInteractionReport", "galleryFavorites", "gallerySave", "galleryPublication", "galleryLike", "galleryFavorite", "galleryShare", "galleryShareReuse", "galleryAuthorProfile", "galleryAssetPreview", "galleryAssetDownload", "assets", "assetDetail", "assetPreview", "assetDownload" };
