  ...
  "boundaries": [
    ...
    },
    {
      ...
      "routes": [
        ...
        {
          "name": "modelProbe",
          "backendConstant": "MODEL_PROBE_FULL",
          "frontendKey": "modelProbe",
        ...
        {
          "name": "modelProviderCredential",
          "backendConstant": "MODEL_PROVIDER_CREDENTIAL_FULL",
          "frontendKey": "modelProviderCredential",
        ...
        {
          "name": "modelProviderParams",
          "backendConstant": "MODEL_PROVIDER_PARAMS_FULL",
          "frontendKey": "modelProviderParams",
        ...
        {
          "name": "modelProviderExecutionReport",
          "backendConstant": "MODEL_PROVIDER_EXECUTION_REPORT_FULL",
          "frontendKey": "modelProviderExecutionReport",
        ...
        {
          "name": "storageStatus",
          "backendConstant": "STORAGE_STATUS_FULL",
          "frontendKey": "storageStatus",
        ...
        {
          "name": "galleryRanking",
          "backendConstant": "GALLERY_RANKING_FULL",
          "frontendKey": "galleryRanking",
        ...
        },
        {
          ...
          "backendConstant": "GALLERY_COLLECTIONS_FULL",
          "frontendKey": "galleryCollections",
        ...
        {
          "name": "galleryCurationRuleConfig",
          "backendConstant": "GALLERY_CURATION_RULE_CONFIG_FULL",
          "frontendKey": "galleryCurationRuleConfig",
        ...
        {
          "name": "galleryLike",
          "backendConstant": "GALLERY_LIKE_FULL",
          "frontendKey": "galleryLike",
        ...
        {
          "name": "galleryShare",
          "backendConstant": "GALLERY_SHARE_FULL",
          "frontendKey": "galleryShare",
        ...
        {
          "name": "galleryAssetDownload",
          "backendConstant": "GALLERY_ASSET_DOWNLOAD_FULL",
          "frontendKey": "galleryAssetDownload",
...
export const SERVICE_BOUNDARY_ROUTE_PATHS = {
  "aigc": {
    ...
    "galleryCurationRuleConfig": "/api/aigc/gallery/curation/rules/config",
    ...
    "galleryRanking": "/api/aigc/gallery/ranking",
    ...
    "modelProviderExecutionReport": "/api/aigc/models/provider-execution-report",
